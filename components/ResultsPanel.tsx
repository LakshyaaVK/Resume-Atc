...
export const ResultsPanel: React.FC<ResultsPanelProps> = ({ result, isLoading, error }) => {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-700/30 p-6 rounded-xl border border-cyan-500/20">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <span className="text-4xl font-black text-cyan-400">{result.skillsAnalysis.score}</span>
                                <span className="text-slate-500 text-xl">/100</span>
                                <div className="flex-1 bg-slate-600/30 rounded-full h-3">
                                    <div 
                                        className="bg-gradient-to-r from-cyan-400 to-cyan-500 h-3 rounded-full transition-all duration-500"
                                        style={{ width: `${result.skillsAnalysis.score}%` }}
                                    ></div>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-700/30 p-6 rounded-xl border border-blue-500/20">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <span className="text-4xl font-black text-blue-400">{result.experienceAnalysis.score}</span>
                                <span className="text-slate-500 text-xl">/100</span>
                                <div className="flex-1 bg-slate-600/30 rounded-full h-3">
                                    <div 
                                        className="bg-gradient-to-r from-blue-400 to-blue-500 h-3 rounded-full transition-all duration-500"
                                        style={{ width: `${result.experienceAnalysis.score}%` }}
                                    ></div>
                                </div>
                            </div>
                            <div className="text-slate-300 leading-relaxed">
                        ...
                        <div className="bg-slate-700/30 p-6 rounded-xl border border-purple-500/20">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <span className="text-4xl font-black text-purple-400">{result.educationAnalysis.score}</span>
                                <span className="text-slate-500 text-xl">/100</span>
                                <div className="flex-1 bg-slate-600/30 rounded-full h-3">
                                    <div 
                                        className="bg-gradient-to-r from-purple-400 to-purple-500 h-3 rounded-full transition-all duration-500"
                                        style={{ width: `${result.educationAnalysis.score}%` }}
                                    ></div>
                                </div>
                            </div>
                            <div className="text-slate-300 leading-relaxed">
    ...
    return (
        <div className="bg-slate-900/50 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-slate-700/30 min-h-[1200px] xl:sticky xl:top-32 relative overflow-hidden group">
